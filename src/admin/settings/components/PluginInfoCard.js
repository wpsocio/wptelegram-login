		...
		<Card border="info" className="mw-100 p-0 text-center">
			...
			<ListGroup variant="flush">
				<ListGroup.Item>
					...
					<div><a href="https://wordpress.org/support/plugin/wptelegram-login/reviews/#new-post" target="_blank" rel="noopener noreferrer" className="text-center text-info ml-1" style={ { textDecoration: 'none' } }><span style={ { color: 'orange', fontSize: '1.5rem' } }>★★★★★</span></a></div>
				</ListGroup.Item>
				<ListGroup.Item>
					<Donate />
				</ListGroup.Item>
