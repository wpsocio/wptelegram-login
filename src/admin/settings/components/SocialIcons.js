...
export default () => {
	const { wptelegram_login: { settings: { assets } } } = window;
	...
	return (
		<Nav variant="pills" className="justify-content-center">
			...
			<Nav.Item className="px-2 py-1">
				<a href="https://t.me/WPTelegram" target="_blank" rel="noopener noreferrer" className="bg-info text-white d-flex" style={ { height: '20px', paddingTop: '1px', paddingRight: '8px', paddingLeft: '6px', paddingBottom: '1px', borderRadius: '3px', textDecoration: 'none' } }>
					<img
						src={ assets.tg_icon }
