...
class WPTelegram_Login_Widget_Primary extends WP_Widget {
	...
	public function form( $instance ) {
		...
		<hr>
		<p>
			<input class="checkbox" type="checkbox" <?php checked( $instance['show_user_photo'], 'on' ); ?> id="<?php echo esc_attr( $this->get_field_id( 'show_user_photo' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'show_user_photo' ) ); ?>" /> 
